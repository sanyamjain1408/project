...
class FiatDeposit {
  ...
  List<DynamicBank>? banks;
  List<PaymentMethod>? paymentMethods;
  List<Wallet>? walletList;
  List<FiatCurrency>? currencyList;

  factory FiatDeposit.fromJson(Map<String, dynamic> json) => FiatDeposit(
        banks: json["banks"] == null ? null : List<DynamicBank>.from(json["banks"].map((x) => DynamicBank.fromJson(x))),
        paymentMethods:
...
class FiatWithdrawal {
  ...
  factory FiatWithdrawal.fromJson(Map<String, dynamic> json) => FiatWithdrawal(
        ...
        myBank: json["my_bank"] == null ? null : List<DynamicBank>.from(json["my_bank"].map((x) => DynamicBank.fromJson(x))),
        paymentMethodList:
