...
class Orders {
  Orders({this.orders, this.orderType, this.totalVolume, this.buyOrders, this.sellOrders});

  List<ExchangeOrder>? orders;
  List<ExchangeOrder>? buyOrders;
  List<ExchangeOrder>? sellOrders;
  String? orderType;
  String? totalVolume;
  ...
  factory Orders.fromJson(Map<String, dynamic> json) => Orders(
        orders: json["orders"] == null
            ? null
            : List<ExchangeOrder>.from(json["orders"].map((x) => ExchangeOrder.fromJson(x))),
        buyOrders: json["buy_orders"] == null
            ? null
            : List<ExchangeOrder>.from(json["buy_orders"].map((x) => ExchangeOrder.fromJson(x))),
        sellOrders: json["sell_orders"] == null
            ? null
            : List<ExchangeOrder>.from(json["sell_orders"].map((x) => ExchangeOrder.fromJson(x))),
...
class SocketTradeInfo {
  ...
  factory SocketTradeInfo.fromJson(Map<String, dynamic> json) => SocketTradeInfo(
        ...
        lastPriceData: json["last_price_data"] == null
            ? null
            : List<PriceData>.from(json["last_price_data"].map((x) => PriceData.fromJson(x))),
      );
}
...
class Trades {
  ...
  factory Trades.fromJson(Map<String, dynamic> json) => Trades(
        transactions: json["transactions"] == null
            ? null
            : List<ExchangeTrade>.from(json["transactions"].map((x) => ExchangeTrade.fromJson(x))),
      );
...
class SocketUserHistory {
  SocketUserHistory(
      {this.orderData, this.orders, this.buyOrders, this.sellOrders, this.stopLimitOrders, this.transactions});
  ...
  factory SocketUserHistory.fromJson(Map<String, dynamic> json) => SocketUserHistory(
        orderData: json["order_data"] == null ? null : OrderData.fromJson(json["order_data"]),
        orders: json["order_data"] == null ? null : List<Trade>.from(json["orders"].map((x) => Trade.fromJson(x))),
        buyOrders:
            json["order_data"] == null ? null : List<Trade>.from(json["buy_orders"].map((x) => Trade.fromJson(x))),
        sellOrders:
            json["order_data"] == null ? null : List<Trade>.from(json["sell_orders"].map((x) => Trade.fromJson(x))),
        stopLimitOrders: json["stop_limit_orders"] == null
            ? []
            : List<StopLimitOrder>.from(json["stop_limit_orders"]!.map((x) => StopLimitOrder.fromJson(x))),
        transactions:
            json["transactions"] == null ? [] : List<Trade>.from(json["transactions"]!.map((x) => Trade.fromJson(x))),
      );
}
...
class FutureTradeMyOrders {
  FutureTradeMyOrders(
      {this.positionOrderList, this.openOrderList, this.orderHistoryList, this.tradeHistoryList, this.transactionList});
  ...
  factory FutureTradeMyOrders.fromJson(Map<String, dynamic> json) => FutureTradeMyOrders(
        positionOrderList: json["position_order_list"] == null
            ? null
            : List<FutureTrade>.from(json["position_order_list"].map((x) => FutureTrade.fromJson(x))),
        openOrderList: json["open_order_list"] == null
            ? null
            : List<FutureTrade>.from(json["open_order_list"].map((x) => FutureTrade.fromJson(x))),
        orderHistoryList: json["order_history_list"] == null
            ? null
            : List<FutureTrade>.from(json["order_history_list"].map((x) => FutureTrade.fromJson(x))),
        tradeHistoryList: json["trade_history_list"] == null
            ? null
            : List<FutureTrade>.from(json["trade_history_list"].map((x) => FutureTrade.fromJson(x))),
