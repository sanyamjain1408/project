...
class Coin {
  ...
  Coin({this.name, this.coinType, this.label, this.value, this.id, this.networkId});

  factory Coin.fromJson(Map<String, dynamic> json) =>
      Coin(name: json["name"], coinType: json["coin_type"], label: json["label"], value: json["value"], id: json["id"], networkId: json["network_id"]);
}
