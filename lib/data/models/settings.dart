...
class CommonSettings {
  ...
  factory CommonSettings.fromJson(Map<String, dynamic> json) => CommonSettings(
    ...
    languageList: json["LanguageList"] == null
        ? null
        : List<AppLanguage>.from(json["LanguageList"].map((x) => AppLanguage.fromJson(x))),
    ...
    enableStaking: makeInt(json["enable_staking"]),
    ...
    navbar: json["navbar"] == null
        ? null
        : Map.from(json["navbar"]).map((k, v) => MapEntry<String, NavMenu>(k, NavMenu.fromJson(v))),
    blogSectionHeading: json["blog_section_heading"],
    blogSectionDescription: json["blog_section_description"],
    socialLoginEnable: makeInt(json["social_login_enable"]),
...
class AppLanguage {
  AppLanguage({required this.id, this.name, this.key, this.status, this.image, this.createdAt, this.updatedAt});
...
class UserSettings {
  ...
  factory UserSettings.fromJson(Map<String, dynamic> json) => UserSettings(
    fiatCurrency: json["fiat_currency"] == null
        ? null
        : List<FiatCurrency>.from(json["fiat_currency"].map((x) => FiatCurrency.fromJson(x))),
...
class LandingData {
  ...
  String? landingFeatureTitle;
  String? landingAdvertisementImage;
  String? landingAdvertisementUrl;
  List<Announcement>? bannerList;
  List<Announcement>? announcementList;
  List<LandingFeature>? featureList;
  int? landingFirstSectionStatus;
  int? landingSecondSectionStatus;
  int? landingThirdSectionStatus;
  int? landingAdvertisementSectionStatus;
  int? landingSixSectionStatus;
  ...
  LandingData({
    ...
    this.landingSixSectionStatus,
    this.landingAdvertisementSectionStatus,
    this.landingAdvertisementImage,
    this.landingAdvertisementUrl,
    this.landingFeatureTitle,
  });
  ...
  factory LandingData.fromJson(Map<String, dynamic> json) => LandingData(
    ...
    bannerList: json["banner_list"] == null
        ? null
        : List<Announcement>.from(json["banner_list"].map((x) => Announcement.fromJson(x))),
    announcementList: json["announcement_list"] == null
        ? null
        : List<Announcement>.from(json["announcement_list"].map((x) => Announcement.fromJson(x))),
    featureList: json["feature_list"] == null
        ? null
        : List<LandingFeature>.from(json["feature_list"].map((x) => LandingFeature.fromJson(x))),
    ...
    landingSixSectionStatus: makeInt(json["landing_sixth_section_status"]),
    landingAdvertisementSectionStatus: makeInt(json["landing_advertisement_section_status"]),
    landingAdvertisementImage: json["landing_advertisement_image"],
    landingAdvertisementUrl: json["landing_advertisement_url"],
    landingFeatureTitle: json["landing_feature_title"],
  );
}
...
class SocialMedia {
  ...
  SocialMedia({this.id, this.mediaTitle, this.mediaLink, this.mediaIcon, this.status, this.createdAt, this.updatedAt});
...
class LandingFeature {
  ...
  factory LandingFeature.fromJson(Map<String, dynamic> json) => LandingFeature(
    id: json["id"],
    featureTitle: json["feature_title"],
    description: json["description"],
    featureIcon: json["feature_icon"],
    status: json["status"],
    featureUrl: json["feature_url"],
    createdAt: json["created_at"] == null ? null : DateTime.parse(json["created_at"]),
    updatedAt: json["updated_at"] == null ? null : DateTime.parse(json["updated_at"]),
  );
}
...
class LandingList {
  ...
  LandingList({this.assetCoinPairs, this.hourlyCoinPairs, this.latestCoinPairs});

  factory LandingList.fromJson(Map<String, dynamic> json) => LandingList(
    assetCoinPairs: json["asset_coin_pairs"] == null
        ? null
        : List<CoinPair>.from(json["asset_coin_pairs"].map((x) => CoinPair.fromJson(x))),
    hourlyCoinPairs: json["hourly_coin_pairs"] == null
        ? null
        : List<CoinPair>.from(json["hourly_coin_pairs"].map((x) => CoinPair.fromJson(x))),
    latestCoinPairs: json["latest_coin_pairs"] == null
        ? null
        : List<CoinPair>.from(json["latest_coin_pairs"].map((x) => CoinPair.fromJson(x))),
  );
}
