...
class Blog {
  ...
  factory Blog.fromJson(Map<String, dynamic> json) => Blog(
        ...
        status: json["status"],
        publishAt: json["publish_at"] == null ? null : DateTime.parse(json["publish_at"]),
        ...
        postId: json["post_id"],
        translationBlogPost: json["translation_blog_post"] == null ? null : List<dynamic>.from(json["translation_blog_post"].map((x) => x)),
      );
}
