...
class _SendSMSScreenState extends State<SendSMSScreen> {
  ...
  Widget build(BuildContext context) {
    return Expanded(
      ...
      children: [
        Align(alignment: Alignment.centerLeft, child: TextRobotoAutoNormal("Verify Phone".tr, fontSize: Dimens.fontSizeMidExtra)),
        vSpacer20(),
        ...
        Obx(() => gUserRx.value.phoneVerified == 1
            ? TextRobotoAutoBold("Verified".tr, fontSize: Dimens.fontSizeLarge, color: Colors.green)
            : buttonRoundedMain(text: "Send SMS".tr, onPress: () => checkInputData())),
        vSpacer20(),
      ],
    ));
  }
