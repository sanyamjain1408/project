...
class _SecurityScreenState extends State<SecurityScreen> {
  ...
  Widget build(BuildContext context) {
    return Expanded(
      child: ListView(
        ...
        children: [
          Align(alignment: Alignment.centerLeft, child: TextRobotoAutoNormal("Profile Security Status".tr, fontSize: Dimens.fontSizeMidExtra)),
          vSpacer10(),
          _basicSecurityView(),
          vSpacer20(),
          Align(alignment: Alignment.centerLeft, child: TextRobotoAutoNormal("Advanced Security".tr, fontSize: Dimens.fontSizeMidExtra)),
          vSpacer10(),
      ...
      return Column(
        children: [
          ...
          _securityItemView(
              ...
              btnColor: user.phoneVerified == 1 ? Colors.green : Colors.grey,
              onTap: () => sendSms()),
          _securityItemView(
              ...
              btnColor: user.isVerified == 1 ? Colors.green : Colors.grey),
        ],
      );
    });
  }
  ...
  Widget _securityItemView({String? imagePath, String? title, String? subTitle, String? btnText, Color? btnColor, VoidCallback? onTap}) {
    return ListTile(
      ...
      title: TextRobotoAutoBold(title ?? "", maxLines: 2),
      subtitle: TextRobotoAutoNormal(subTitle ?? "", maxLines: 3),
      trailing: buttonText(btnText ?? "", bgColor: btnColor, textColor: Colors.white, visualDensity: VisualDensity.compact),
  ...
  Expanded _showDeleteAccountView() {
    return Expanded(
      child: ListView(
        shrinkWrap: true,
        padding: const EdgeInsets.all(Dimens.paddingMid),
        children: [
          ...
          vSpacer20(),
          TextRobotoAutoNormal("Do you want to delete your account".tr,
              maxLines: 5, color: Get.theme.primaryColor, fontSize: Dimens.fontSizeMid),
          vSpacer20(),
          TextRobotoAutoBold("The Reason For Delete".tr),
          vSpacer2(),
          textFieldWithSuffixIcon(controller: reasonEditController, hint: "Write Your Reason".tr, maxLines: 5, height: 100),
          TextRobotoAutoNormal("(${"Write your reason with as details as possible".tr})", maxLines: 2, color: Colors.redAccent),
          vSpacer10(),
          TextRobotoAutoBold("Current Password".tr),
          vSpacer2(),
          textFieldWithSuffixIcon(controller: passwordEditController, hint: "Write Your Password".tr, isObscure: true),
          vSpacer20(),
          buttonRoundedMain(text: "Delete".tr, bgColor: Colors.redAccent, onPress: () => _confirmDeleteAccount()),
          vSpacer20(),
        ],
      ),
    );
