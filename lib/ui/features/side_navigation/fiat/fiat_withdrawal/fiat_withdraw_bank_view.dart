...
class FiatWithdrawBankPage extends StatefulWidget {
  const FiatWithdrawBankPage({super.key, required this.paymentType});
        ...
        widget.paymentType == PaymentMethodType.bank
            ? Column(
                children: [
                  ...
                  Obx(() {
                    return dropDownListIndex(_controller.getBankList(_controller.fiatWithdrawalData.value), selectedBankIndex.value, "Select Bank".tr,
                        (index) {
