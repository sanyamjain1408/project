...
class ColorItemView extends StatelessWidget {
  const ColorItemView(this.title, this.cList, this.isSelect, this.isList, this.onTap, {super.key});
  final String title;
...
class PreferenceItemView extends StatelessWidget {
  const PreferenceItemView(this.title, this.index, this.isSelect, this.isList, this.onTap, {super.key});
  final String title;
  final VoidCallback onTap;
  final bool isSelect;
  final bool isList;
