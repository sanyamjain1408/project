    ...
    return Column(
      children: [
        tabBarUnderline(["Position".tr, "Open Orders".tr, "Order History".tr, "Trade History".tr, "Transaction History".tr], orderTabController,
            isScrollable: true, fontSize: Dimens.fontSizeMid, onTap: (index) {
...
class FutureTradeItemView extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final fontSize = isTextScaleGetterThanOne(context) ? Dimens.fontSizeMidExtra : Dimens.fontSizeMid;
    ...
    return Padding(
      ...
      child: Column(
        children: [
          ...
          if (selectedTab == 3)
            twoTextSpaceFixed("${"Role".tr}: ", "Taker".tr, fontSize: Dimens.fontSizeMid, color: pColorL, subColor: Colors.red),
          if (selectedTab == 1)
            Row(
...
class TakeProfitStopLossView extends StatelessWidget {
  ...
  Column _commonInfoView(FutureTrade trade, String reduce, double? price, bool isBuy, {String? title}) {
