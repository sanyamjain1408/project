      ...
      body: SafeArea(
        child: ListView(
          ...
          children: [
            ...
            Obx(() {
              return Row(children: [
                CheckBoxView(checkPrivacy.value, (value) => checkPrivacy.value = value),
                Expanded(
                  child: textSpanWithAction(
                      "By creating an account, I agree to".trParams({"appName": appName.value}), "${"Privacy Police".tr}.", maxLines: 3,
                      textAlign: TextAlign.start,
                      onTap: () => openUrlInBrowser(URLConstants.privacyLink)),
                )
              ],);
            },),
            vSpacer15(),
            buttonRoundedMain(text: "Sign Up".tr, onPress: () => _controller.isInPutDataValid(context, checkPrivacy.value)),
            vSpacer20(),
