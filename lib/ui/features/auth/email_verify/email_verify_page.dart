// OTP / Email Verification Page - TEMPORARILY DISABLED
// Re-enable this file when OTP facility is ready
//
...
//                         const Text("Verify",
//                             style: TextStyle(fontSize: 40, fontWeight: FontWeight.bold, color: Colors.white, height: 1)),
//                         const SizedBox(height: 5),
//                         const Text("Your",
//                             style: TextStyle(fontSize: 40, fontWeight: FontWeight.bold, color: Colors.white, height: 1)),
//                         const SizedBox(height: 5),
//                         const Text("Email",
//                             style: TextStyle(fontSize: 40, fontWeight: FontWeight.bold, color: _green, height: 1)),
//                         SizedBox(height: gap),
//                         RichText(
//                           text: TextSpan(
//                             style: const TextStyle(fontSize: 13, color: Colors.white70, height: 1.5),
//                             children: [
//                               TextSpan(text: "${'Enter verification code which sent email'.tr} "),
//                               TextSpan(
...
//                             child: InkWell(
//                               onTap: () => _controller.isInPutDataValid(context, widget.registrationId),
//                               borderRadius: BorderRadius.circular(12),
//                               child: const Center(
//                                 child: Text(
//                                   "VERIFY",
//                                   style: TextStyle(color: Colors.black, fontSize: 17, fontWeight: FontWeight.bold, letterSpacing: 1.5),
//                                 ),
//                               ),
//                             ),
//                           ),
...
//                           children: [
//                             const Text("Back to ", style: TextStyle(color: Colors.white)),
//                             InkWell(
//                               onTap: () => Get.off(() => const SignInPage()),
